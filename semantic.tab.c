...
{
       0,    59,    59,    67,    68,    73,    72,    90,    92,    99,
     110,   122,   124,   128,   132,   144,   154,   156,   160,   161,
     162,   163,   164,   168,   172,   184,   185,   193,   194,   200,
     201,   203,   213,   223,   226,   232,   231,   250,   252,   259,
     269,   270,   274,   280,   288,   299
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_INC", "_FUN", "ONLY_IF", "$accept", "program", "function_list",
  "function", "$@1", "parameters", "body", "variable_list", "variable",
  "vars", "statement_list", "statement", "compound_statement",
  "assignment_statement", "num_exp", "exp", "increment", "literal",
  "function_call", "$@2", "argument", "if_statement", "if_part", "rel_exp",
...
{
     -11,    20,    26,   -11,   -54,    40,   -54,   -54,   -54,    23,
      50,    47,    27,    39,    44,    54,   -54,   -54,    51,    56,
     -54,    53,   -54,     4,    -1,   -54,   -54,    55,    57,    21,
     -12,   -54,   -54,   -54,   -54,   -54,   -54,   -54,    58,   -54,
     -54,    34,    -2,   -54,   -54,    34,   -54,    17,   -54,   -54,
     -54,    34,    46,     9,    33,    32,    59,   -54,    61,     7,
     -54,    34,    31,   -54,   -54,   -54,    34,    33,    34,   -54,
     -54,   -54,    48,   -54,    35,    62,    34,   -54,    48
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    16,    10,    17,    18,    19,    22,    20,    40,    21,
      15,     0,    28,    33,    34,     0,    45,     0,    25,    27,
      29,     0,     0,     0,     0,     0,     0,    31,     0,     0,
      44,     0,     0,    32,    23,    41,     0,     0,    37,    30,
      26,    24,    43,    42,    38,     0,     0,    36,    39
};
...
{
      55,    65,    51,    28,    59,    29,    30,    52,   -35,     1,
      62,    31,    32,    28,    73,    29,    30,    57,    69,    26,
      27,    31,    64,     5,    61,    72,     6,    74,    42,    43,
      44,    45,    60,    10,    61,    78,    46,    28,    14,    29,
      30,    42,    43,    44,    45,    31,    71,     8,    61,    61,
      66,    76,    61,    11,    13,    15,    16,    18,    20,    21,
      25,    63,    40,    54,    70,    61,     7,    41,    53,     0,
      67,    68,     0,    77
};

static const yytype_int8 yycheck[] =
{
      41,    54,    14,     4,    45,     6,     7,    19,    10,    20,
      51,    12,    13,     4,    67,     6,     7,    19,    11,    15,
      16,    12,    13,     3,    17,    66,     0,    68,     7,     8,
       9,    10,    15,    10,    17,    76,    15,     4,    11,     6,
       7,     7,     8,     9,    10,    12,    15,     7,    17,    17,
      18,    16,    17,     3,     7,    16,    12,     3,     7,     3,
       7,    15,     7,     5,    61,    17,     3,    10,    31,    -1,
      11,    10,    -1,    11
};
...
{
       0,    20,    23,    24,    25,     3,     0,    25,     7,    26,
      10,     3,    27,     7,    11,    16,    12,    28,     3,    29,
       7,     3,    30,    31,    32,     7,    15,    16,     4,     6,
       7,    12,    13,    33,    34,    35,    38,    43,    44,    46,
       7,    10,     7,     8,     9,    10,    15,    36,    37,    39,
      40,    14,    19,    32,     5,    36,    45,    19,    41,    36,
      15,    17,    36,    15,    13,    33,    18,    11,    10,    11,
      37,    15,    36,    33,    36,    42,    16,    11,    36
};
...
#line 308 "semantic.y" /* yacc.c:1906  */
